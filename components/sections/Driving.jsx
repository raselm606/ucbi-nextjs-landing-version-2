                    ...
                    <div className=" col-md-6 col-lg-6">
                        <div className="driving_content">
                            ...
                            <p className="section_paragraph_dark t1_width">
                                <strong>UCBI</strong>’s mission is to support disciplined and sustainable treasury development through a long-term strategy grounded in strong governance principles operating as  strategic holding and structure the platform focuses on Ethereum accumulation and diversified multi-asset for all capital allocation within robust organizational frameworks this ensures alignment with the regulatory standards operational resilience and institutional discipline through prudent capital structuring structured private investment and comprehensive risk management the framework seeks the sustainable growth while maintaining a controlled confidential environment enabling the innovation for stability compliance and long-term shareholder confidence
                            </p>
                            <div className="deatureBox">
                             ...
                             <Button target="_blank" href="https://advisory.ucbibanking.io/" className="primaryBtn">
                                Learn More
