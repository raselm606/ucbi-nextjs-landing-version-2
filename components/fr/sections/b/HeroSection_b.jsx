          ...
          <div className="col-lg-6">
            <div className={styles.heroContent}>
              ...
              <p className={styles.heroText}>
                Infrastructure blockchain privée stratégie de trésorerie et solutions Ethereum pour l’accompagnement institutionnel en actifs numériques de partenaires sélectionnés et d’actionnaires engagés sur le long terme
              </p>
