                ...
                <div className="offset-lg-2 col-lg-6">
                    ...
                    <div className="adsec_area">
                        ...
                        <div className="advancing_para">
                            ...
                            <p >La gestion de trésorerie repose sur une allocation diversifiée du capital et des stratégies de liquidité pour optimiser le rendement ajusté au risque assurer une performance résiliente et créer de la valeur durable pour les actionnaires</p>
                        </div>
                   ...
                   <div className="adsec_area dli">
                        ...
                        <div className="advancing_para">
                            ...
                            <p >Le renforcement du cadre institutionnel repose sur une excellente gouvernance et une cohérence opérationnelle favorisant la résilience à long terme la confiance des parties prenantes et la création de valeur durable par des contrôles internes efficaces</p>
                        </div>
                    </div>
                    ...
                    <div className="adsec_area">
                        ...
                        <div className="advancing_para">
                            ...
                            <p >Les partenariats internationaux offrent une échelle suffisante pour développer des solutions innovantes et étendre notre écosystème nous investissons dans des collaborations stratégiques pour soutenir une croissance durable et accélérer la diffusion blockchain</p>
                        </div>
                    </div>
